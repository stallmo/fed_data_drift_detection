...
if __name__ == '__main__':
    ...
    save_results = False  # whether to save results dictionary as pickle file
    ...
    n_repeats = 100  # number of times the experiment is repeated
    n_time_steps = 10  # number of time steps in each repeat
    acceptability_threshold = 0.01  # 0.05 means 5% deviation from initial Davies-Bouldin is acceptable
