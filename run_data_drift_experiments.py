...
if __name__ == '__main__':
    ...
    n_clients = 4
    ratio_drifted_clients = 0.5  # only relevant for global drift
    drifting_clients = int(n_clients * ratio_drifted_clients)
    ratio_new_data_distribution = 0.5  # how many of the new data points are generated by new distributions. rest is generated by old distributions
    dim_data = 2
