...
if __name__ == '__main__':
    ...
    ideal_cluster_num_deviation = 0.0  # phi. determines deviation from ideal number of clusters. 0.0 means ideal number of clusters is used. Can be positive or negative.
    ...
    ratio_new_data_distribution = 0.0  # how many of the new data points are generated by new distributions. rest is generated by old distributions -> rho

    ##### Experiment parameters (fixed and derived) #####
