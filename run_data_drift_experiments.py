...
if __name__ == '__main__':
    ...
    run_mode = 'global_drift_unused_generators'  # 'no_local_drift'  # 'local_but_no_global_drift' # global_drift # 'global_drift_unused_generators'
    n_repeats = 10  # number of times the experiment is repeated
    n_time_steps = 10  # number of time steps in each repeat
    acceptability_threshold = 0.05  # 0.05 means 5% deviation from initial Davies-Bouldin is acceptable

    n_clients = 10  # number of clients participating in the federation
    ratio_unused_client_generators = 0.3  # ratio of clients of which data generators are not used -> only global drift
    ...
    assume_num_clust_known = True  # determines whether we assume the number of clusters to be known
    if assume_num_clust_known:
    ...
    dict_experiments_results = {'config': {'run_mode': run_mode,
                                           ...
                                           'assume_num_clust_known': assume_num_clust_known,
